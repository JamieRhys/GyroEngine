...
LDLIBSOPTIONS=-lboost_filesystem -lboost_system -lsfml-audio-d -lsfml-graphics-d -lsfml-network-d -lsfml-system-d -lsfml-window-d
...
${OBJECTDIR}/src/gyroEngine/engine/GyroEngine.o: src/gyroEngine/engine/GyroEngine.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/gyroEngine/engine/GyroEngine.o src/gyroEngine/engine/GyroEngine.cpp

${OBJECTDIR}/src/main/main.o: src/main/main.cpp
	${MKDIR} -p ${OBJECTDIR}/src/main
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/main/main.o src/main/main.cpp
